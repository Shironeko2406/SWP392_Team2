...
const ManageSubject = () => {
  ...
  useEffect(() => {
    ...
    if (subjectList.length > 0) {
      ...
      tableRef.current = $("#subject-manage-table").DataTable();
    }
  }, [subjectList]);
      ...
      <div className="col-md-12">
        <div className="card">
          <div className="card-header">
            <h4 className="card-title">Subject Management</h4>
          </div>
          <div className="card-body">
            <div className="table-responsive">
              <table
                id="subject-manage-table"
              ...
              >
                ...
                <tbody>
                  {subjectList.map((sub) => (
                    <tr key={sub.languageId}>
                      <td>{sub.languageId}</td>
